  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col border-t border-borde p-4">
        ...
        {/* flex-wrap + ml-auto: en pantallas de 360 px las tarjetas quedan de
            ~150 px y el precio con el botón no entran en una línea — sin esto
            el botón desbordaba el padding y pisaba el precio. Al envolver, el
            botón baja de línea y el ml-auto lo mantiene alineado a la derecha. */}
        <div className="mt-4 flex flex-wrap items-end justify-between gap-2 pt-1">
          ...
          <button
            ...
            className="ml-auto rounded-full bg-tinta px-4 py-2 text-xs tracking-wide text-crema transition-colors hover:bg-ladrillo disabled:cursor-not-allowed disabled:bg-borde disabled:text-tinta-tenue"
          >
            {estado === "agotado"
              ? "Agotado"
              : agregado
